...
ui <- fluidPage(
  ...
  tabsetPanel(
             ...
             fluidPage(
               ...
               fluidRow(
                 column(6,
                        ...
                        img(src = "get_TF_TG_val_Example_.png", height = "200px")
                 ),
                 column(6,
    ...
    tabPanel("Validation Scores",
      ...
      numericInput("validation_freq", "Validation Frequency", value = 1, min = 1, max = 4),
      helpText("Enter a validation frequency threshold (1 to 4). This represents the frequency of validation of the TF-TG interactions."),
    ...
    tabPanel("TF-TG Validation Score Plot",
             sidebarLayout(
               sidebarPanel(
                 ...
                 numericInput("validation_freq_val", "Validation Frequency", value = 1, min = 1, max = 4),
                 helpText("Set the validation frequency threshold (1 to 4)."),
                 numericInput("max_size_val", "Max Size", value = 30, min = 1),
    ...
    tabPanel("Combined TFs Network",
             sidebarLayout(
               sidebarPanel(
                 ...
                 numericInput("max_TFs_network", "Max TFs per Gene", value = 10, min = 1),
                 helpText("Set the maximum number of TFs shown for each gene. Default is 10."),
                 numericInput("max_targets_network", "Max Targets per Gene", value = 10, min = 1),
