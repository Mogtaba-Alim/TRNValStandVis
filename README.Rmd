  ...
  <table>
    <tr>
      <td>
        ...
        <br>
        <em>1. plot_tf_regulon: [Plots a graph showing all the TF's that regulate a given gene and all the TG's regulated by it.]</em>
      </td>
      <td>
        ![](inst/extdata/plot_TF_TG_val_Example.png)
        <br>
        <em>Explanation for Image 2: [This function plots the target genes against their TF_TG_Exp_qual_score for a specified Transcription Factor (TF).]</em>
      </td>
    </tr>
    <tr>
      <td>
